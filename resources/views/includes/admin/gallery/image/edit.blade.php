                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="file_url" name="file_url" style="font-size: 12px" value="{{ config('app.url') . $image->file_url }}">
                            <div class="input-group-append">
                                <button class="btn btn-outline-secondary" type="button" onclick="copyToClipboard(event)"><i class="fas fa-copy pe-none"></i></button>
                            </div>
                        </div>
                    </div>
