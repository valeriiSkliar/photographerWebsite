                        ...
                        <div class="card-body">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">
                                    ...
                                    <img src="{{ asset($section->sectionContent->background_image) }}" alt="Background Image"
                                         width="200" class="img-thumbnail">
                                </li>
                                <li class="list-group-item"><strong>Title:</strong> {{ $section->sectionContent->title }}</li>
                                <li class="list-group-item"><strong>Description:</strong> {{ $section->sectionContent->description }}
                                </li>
                                <li class="list-group-item"><strong>Content Text:</strong> {{ $section->sectionContent->content_text }}
                                </li>
                            </ul>                        </div>
                    </div>
                </div>
