...
{{--                    <a class="relative" href="{{route('page.' . $page->slug)}}">--}}
{{--                        <img class="w-full object-cover h-full" src="{{ $imageMap[$page->name]->file_url }}"--}}
{{--                             alt="{{$imageMap[$page->name]->alt_text}}">--}}
{{--                        <h2 class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white opacity-90 text-4xl text-center">--}}
{{--                            {{$page->name}}--}}
{{--                        </h2>--}}
{{--                    </a>--}}
{{--                </div>--}}
