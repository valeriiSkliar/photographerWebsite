...
if (!function_exists('fetchAllFileExtensions')) {
    ...
    function fetchAllFileExtensions()
    {
        ...
        return !empty($extensions) ? json_decode($extensions, true) :array(__('No Extension Available'));
    }
}
...
if (!function_exists('checkNullExtension')) {
    ...
    {
        return $data == null ? array(__('No Extension Available')) : $data;
    }
...
if (!function_exists('getFileExtensions')) {
    ...
    {
        $extensions = array(
            0 => ['webp', 'jpg', 'jpeg', 'png', 'bmp', 'gif', 'doc', 'docx', 'xls', 'xlsx', 'csv', 'pdf', 'mp4', '3gp', 'ico'],
            1 => ['webp', 'jpg', 'jpeg', 'png', 'gif', 'doc', 'docx', 'pdf'],
            2 => ['webp', 'jpg', 'jpeg', 'png', 'gif', 'bmp'],
            3 => ['webp', 'jpg', 'jpeg', 'png'],
            4 => ['ico'],
